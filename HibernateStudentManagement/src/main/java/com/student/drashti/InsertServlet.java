...
//	        out.print("Student details are Inserted");
			response.sendRedirect("addUserForm.html");
			
			break;
		case "getAllUserServlet":
			//Student s=new Student();
			...
			for (Student stu : l1) {
				...
				+ "</a></td><td><a href='getUserById.jsp?name=" + stu.getName() + "'>" + stu.getName() + "</a></td><td>"
				+stu.getEmail() + "</td><td>" +stu.getPassword() + "</td><td><a href='InsertServlet?action=deleteUser&id="+stu.getId()
		...
		case "deleteUser":
			...
			response.sendRedirect("InsertServlet?action=getAllUserServlet");
			break;
		...
		case "getSingleUser":
			...
			out.print("<table border='1'>");
			out.print("<tr><th>Id</th><th>Name</th><th>email</th><th>Password</th><th>Delete</th><th>Update</th></tr>");
			out.print("<tr><td>"+s2.getId()+"</td><td>"+s2.getName()+"</td><td>"+s2.getEmail()+"</td><td>"+s2.getPassword()+"</td><td>Delete</td><td>Update</td></tr>");
			out.print("<a href='addUserForm.html'>Add Student Details here</a>");
			out.print("<a href='addUserForm.html'>Add New Student Details</a>");
			out.print("<a href='InsertServlet?action=getAllUserServlet'>View All Student Details</a>");
		}
